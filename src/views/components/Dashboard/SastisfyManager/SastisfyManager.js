...
export default function SastisfyManager() {
    ...
    getStatistical(selectedFilter, {
      ...
      if (data.success) {
        ...
        setDataDashboardPie([
          ...
          data.data?.totalCancel,
          data.data?.totalWaiting,
          data.data?.totalAccept,
          data.data?.totalDelivery,
          data.data?.totalFinishDelivery,
          data.data?.totalFail,
        ]);
      }
    });
  ...
  const fetchRunningOutProduct = async () => {
                ...
                <div className="number">
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3}>
                        {index === 0 &&
                          formatCurrencyVND(dataDashboard?.totalRevenue)}
                        {index === 1 && dataDashboard?.totalQuantity}
                        {index === 2 && dataDashboard?.totalSuccess}
                        {index === 3 && dataDashboard?.totalCancel}
                      </Title>
                    </Col>
                    <Col xs={6}>
        ...
        <Row gutter={[24, 0]}>
          <Col xs={24} sm={24} md={12} lg={12} xl={12} className="mb-24">
            <Card bordered={false} className="criclebox cardbody h-full">
              <div className="project-ant">
                <div>
                  <Title level={5}>Top 5 sản phẩm bán chạy nhất</Title>
                  ...
                  <tbody>
                    {bestSale.map((item, index) => (
                      <tr key={index}>
                        <td>
                          <img
                            src={getMediaUrl(item.images[0]?.imageUrl)}
                            alt=""
          ...
          <Col xs={24} sm={24} md={12} lg={12} xl={12} className="mb-24">
            <Card bordered={false} className="criclebox cardbody h-full">
              <div className="project-ant">
                <div>
                  <Title level={5}>Top 5 sản phẩm sắp hết hàng</Title>
                  {/* <Paragraph className="lastweek">
                    done this month<span className="blue">40%</span>
                  </Paragraph> */}
                </div>
