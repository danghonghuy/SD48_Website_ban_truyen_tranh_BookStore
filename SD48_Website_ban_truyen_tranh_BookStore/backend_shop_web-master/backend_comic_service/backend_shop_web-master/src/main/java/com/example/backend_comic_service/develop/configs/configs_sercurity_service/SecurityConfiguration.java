    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .requestMatchers("/api/user/**","/api/product/get-list-product","/api/product/detail","/api/category/get-category-list",
                        "/api/rating/add-or-change", "/api/product/selling-best","/api/user/forget-user","/api/product/running-out",
                        "/swagger-ui/**","/swagger-resources/**", "/webjars/**", "/uploads/**","/api/types/get-list-type",
                        "/v3/api-docs/**", "/login")
                .permitAll()
                .anyRequest()
                .authenticated()
