...
public class AddressServiceImpl implements IAddressService {
    ...
    @Override
    public void bulkInsertAddress(List<AddressModel> models, UserEntity entity, UserEntity userHandle, Integer isChangeOrder, OrderEntity orderEntity) {
        try {
            if (!models.isEmpty()) {
//                if (isChangeOrder != null && isChangeOrder == 1) {
//                    orderRepository.updateAddress(orderEntity.getId());
//                    addressRepository.bulkDeleteByUserId(orderEntity.getUser().getId());
//                    userRepository.bulkDeleteByUserId(orderEntity.getUser().getId());
//                }
