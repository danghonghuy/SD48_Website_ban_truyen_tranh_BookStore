  ...
  const handleAddToCart = () => {
    dispatch(
      addProductToCart({
        id: params.id,
        imgSrc:
          productDetail.images != undefined ? productDetail.images[0] : fruit,
        name: productDetail.name,
        price: productDetail.discountDTO?.moneyDiscount
          ? productDetail.price - productDetail.discountDTO?.moneyDiscount
          : productDetail.price,
        count: count,
      })
    );
      ...
      decreaseQuantity({
        ...
        imgSrc:
          productDetail.images != undefined
            ? productDetail.images[0]?.fileName
            : fruit,
        name: productDetail.name,
        price: productDetail.price,
        count: count,
            ...
            <div class="col-lg-8 col-xl-9">
              <div class="row g-4">
                  ...
                  <div class="border rounded">
                    <a href="#">
                      <img
                        src={
                          productDetail.images != undefined
                            ? getMediaUrl(productDetail.images[0])
                            : fruit
                        }
                ...
                <div class="col-lg-6">
                  ...
                  <p class="mb-3">Danh mục: {productDetail.categoryName}</p>
                ...
                <div class="col-lg-12">
                  ...
                  <div class="tab-content mb-5">
                    ...
                    >
                      ...
                      <p>Số lượng : {productDetail.stock} </p>
                      <p>Xuất xứ :{productDetail.publisher} </p>
